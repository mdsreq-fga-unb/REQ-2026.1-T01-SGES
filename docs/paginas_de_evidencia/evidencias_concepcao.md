...
* **Evidências:**
    * Link ou referência para a [Ata de Reunião](../reuniao_de_alinhamento.md) ou transcrição onde a técnica ocorreu.
...
* **Evidências:**
    * Link para o [Vídeo de Apresentação / Demonstração](../unidade_1_video.md) correspondente à Unidade.
