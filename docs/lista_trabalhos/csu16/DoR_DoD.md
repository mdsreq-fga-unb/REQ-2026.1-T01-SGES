...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU16` no sistema de controle de versão (ex: nos commits/PRs)?
    ...
    * **Commits principais:** [`62472bb`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/62472bb), [`b9ed321`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/b9ed321)
