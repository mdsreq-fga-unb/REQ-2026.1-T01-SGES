...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU14` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** [#71](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/pull/71) (docs: atualizar andamento dos casos de uso para concluído)
    * **Commits principais:** [`43bd132`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/43bd132), [`f582c5d`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/f582c5d)
