...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU01` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** [#32](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/pull/32) (feat: implementa fluxo de autenticação e dashboard base (FSD))
    * **Commits principais:** [`43796d5`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/43796d5), [`182d96e`](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-SGES/commit/182d96e)
