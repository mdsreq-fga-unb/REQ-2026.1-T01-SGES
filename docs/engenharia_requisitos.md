...
| **Construção**            | • Refinamento<br>• Verificação e Validação<br>• Organização e Atualização                                          | • Desenvolvimento incremental<br>• Revisão de requisitos implementados<br>• Atualização contínua dos Itens de Trabalho e Ajuste dos requisitos conforme evolução do projeto | • User Stories<br>• Definition of Done (DoD)<br>• Feedback contínuo                               | • Implementação contínua das funcionalidades<br>• Funcionalidades validadas e prontas para entrega                                                                                                                                                                                 |
