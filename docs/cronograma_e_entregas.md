...
| CSU15 | Gerar Relatório de Frequência             | Gestor       | Consolidar e exportar em CSV os percentuais de engajamento segmentados por turmas ou mês.        | CA16-01: Exportação em formato CSV.<br>CA16-02: Dados correspondem estritamente aos filtros aplicados.<br>CA16-03: Colunas e delimitadores formatados adequadamente para leitura externa.       |
