...
import { InstructorHistoryTypeormRepository } from "../orm/repositories/instructor-history-repository";
...
function buildQueueProducer() {
  ...
  logger.info(
    "Nenhuma configuração de email encontrada — emails desabilitados (NoopQueueProducer)",
  );
  ...
  return (
    new DIContainer()
      ...
      .add(
        ...
        () => new EnrollmentTypeormRepository(dataSource),
      )
      .add(
        "AttendanceRepository",
        () => new AttendanceTypeormRepository(dataSource),
      )
      .add(
        "NotificationRepository",
        () => new NotificationTypeormRepository(dataSource),
      )
      .add(
        "SecurityLogRepository",
        () => new SecurityLogTypeormRepository(dataSource),
      )
      .add(
        "InstructorHistoryRepository",
        () => new InstructorHistoryTypeormRepository(dataSource),
      )
      // Services
      ...
      .add(
        ...
        ({ UserRepository }) =>
          new CreateUserUseCase(
            UserRepository,
            new CreateUserUsecaseZodValidator(),
            queueProducer,
          ),
      )
      .add(
        "DeleteUserUsecase",
        ({ UserRepository, SecurityLogRepository }) =>
          new DeleteUserUseCase(
            UserRepository,
            new DeleteUserUsecaseZodValidator(),
            SecurityLogRepository,
          ),
      )
      .add(
        ...
        ({ UserRepository, SecurityLogRepository }) =>
          new UpdateUserUseCase(
            UserRepository,
            new UpdateUserUsecaseZodValidator(),
            SecurityLogRepository,
          ),
      )
      .add(
        ...
        ({ UserRepository }) =>
          new ListUsersUseCase(
            UserRepository,
            new ListUsersUsecaseZodValidator(),
          ),
      )
      .add(
      ...
      .add(
        ...
        ({ UserRepository }) =>
          new ResetPasswordUseCase(
            UserRepository,
            new ResetPasswordUsecaseZodValidator(),
          ),
      )
      // Enrollment use cases
      .add(
        "EnrollStudentUsecase",
        ({ StudentRepository, ClassRepository, EnrollmentRepository }) =>
          new EnrollStudentUseCase(
            StudentRepository,
            ClassRepository,
            EnrollmentRepository,
            new EnrollStudentZodValidator(),
          ),
      )
      .add(
        "BulkEnrollStudentsUsecase",
        ({ StudentRepository, ClassRepository, EnrollmentRepository }) =>
          new BulkEnrollStudentsUseCase(
            StudentRepository,
            ClassRepository,
            EnrollmentRepository,
            new BulkEnrollStudentsZodValidator(),
          ),
      )
      .add(
        "GetEnrollmentAbsencesUsecase",
        ({ EnrollmentRepository, AttendanceRepository }) =>
          new GetEnrollmentAbsencesUseCase(
            EnrollmentRepository,
            AttendanceRepository,
          ),
      )
      ...
      .add(
        "TeacherRegisterPresenceUsecase",
        ({
          ClassRepository,
          StudentRepository,
          EnrollmentRepository,
      ...
      .add(
        ...
        ({
          ...
          new ListAttendanceByDateUseCase(
            ClassRepository,
            EnrollmentRepository,
            StudentRepository,
            AttendanceRepository,
